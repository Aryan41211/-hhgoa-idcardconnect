  ...
  return (
    <section className="mx-auto max-w-6xl px-5 pb-16">
      ...
      <div className="mt-12 grid gap-6 sm:grid-cols-2">
        ...
        >
          ...
          <p className="mt-2 font-label text-xs text-cream/65">
            Wrap your photo in the signature HH Goa frame — ready as your X profile picture.
          </p>
        ...
        >
          ...
          <p className="mt-2 font-label text-xs text-cream/65">
            Photo + name + stack + an auto-generated builder title, laid out like an event badge.
          </p>
          <span className="mt-6 inline-block rounded-full bg-punch px-5 py-2 font-display text-sm tracking-widest text-white">
            START →
          </span>
      ...
      <div className="mt-8 text-center">
        <a
          href="/squad"
          className="inline-block rounded-2xl bg-cream/5 px-6 py-4 font-label text-sm text-cream/80 ring-1 ring-cream/20 transition hover:bg-cream/10"
        >
          👥 Plus: <span className="text-gold">SQUAD MODE</span> — one link, bring your teammates into one combined frame
        </a>
      </div>
    </section>
  );
